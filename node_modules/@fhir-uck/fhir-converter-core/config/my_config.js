        ...
        component: [
            {
                ...
                valueQuantity: {
                    ...
                    unit: '#Observation.heightUnit',
                    system: 'http://unitsofmeasure.org',
                    code: '#Observation.heightUnit'
                }
            },
            {
                code: {
                ...
                valueQuantity: {
                    ...
                    unit: '#Observation.weightUnit',
                    system: 'http://unitsofmeasure.org',
                    code: '#Observation.weightUnit'
                }
            },
            {
                code: {
...
module.exports.fields = [
    ...
    // subject.reference is now handled in the template using #Patient.patientId
    {
        source: 'heightValue',
    ...
    {
        source: 'heightUnit',
        target: 'ObservationVitalSigns.component[0].valueQuantity.unit'
    },
    {
        source: 'heightUnit',
        target: 'ObservationVitalSigns.component[0].valueQuantity.code'
    },
    {
        source: 'weightValue',
    ...
    {
        source: 'weightUnit',
        target: 'ObservationVitalSigns.component[1].valueQuantity.unit'
    },
    {
        source: 'weightUnit',
        target: 'ObservationVitalSigns.component[1].valueQuantity.code'
    },
    {
        source: 'bmi',
