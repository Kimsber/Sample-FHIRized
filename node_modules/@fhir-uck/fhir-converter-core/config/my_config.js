...
module.exports.beforeProcess = (data) => {
    if (data.Height (cm) && data.Weight (kg)) {
        let heightM = data.Height (cm) === 'cm' ? data.heightValue / 100 : data.heightValue;
        data.bmi = +(data.Weight (kg) / (heightM * heightM)).toFixed(2);
    }
    return data;
}
